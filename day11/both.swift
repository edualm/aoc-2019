...
func printBoard(coordinates: [Coordinate], board: [Coordinate: Robot.Color]) {
    ...
    for y in smallestY!...biggestY! {
        var buf = ""
        
        for x in smallestX!...biggestX! {
            let color = board[Coordinate(x: x, y: y)] ?? .black
...
printBoard(coordinates: p2Robot.paintedCoordinates, board: p2Robot.board)
